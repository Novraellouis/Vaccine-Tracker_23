...
namespace DelVaksin
{
    ...
    public class AllFunc : IAllFunc
    {
        ...
        public bool gunakanVaksin(Vaksin vaksin)
        {
            ...
            Vaksin report = delVaksin.Vaksin.SingleOrDefault(x => x.ID_vaksin == vaksin.ID_vaksin);
            report.status = 7;
        ...
        {
            DEL_VAKSINEntities delVaksin = new DEL_VAKSINEntities();
            delVaksin.Penduduk.Add(penduduk);
            delVaksin.SaveChanges();
            delVaksin.Dispose();
            return true;
        }
        ...
        {
            DEL_VAKSINEntities delVaksin = new DEL_VAKSINEntities();
            Vaksin t_vaksin = delVaksin.Vaksin.SingleOrDefault(x => x.ID_vaksin == vaksin.ID_vaksin);
            t_vaksin.status = 1;
            delVaksin.SaveChanges();
        ...
        {
            DEL_VAKSINEntities delVaksin = new DEL_VAKSINEntities();
            Vaksin t_vaksin = delVaksin.Vaksin.SingleOrDefault(x => x.ID_vaksin == id);
            delVaksin.Vaksin.Remove(t_vaksin);
            delVaksin.SaveChanges();
            delVaksin.Dispose();
            return true;
        }
        ...
        {
            DEL_VAKSINEntities delVaksin = new DEL_VAKSINEntities();
            Penduduk penduduk = delVaksin.Penduduk.SingleOrDefault(x => x.NIK == NIK);
            penduduk.status = 3;
            delVaksin.SaveChanges();
            delVaksin.Dispose();
            return true;
        ...
        {
            DEL_VAKSINEntities delVaksin = new DEL_VAKSINEntities();
            Vaksin vaksin = delVaksin.Vaksin.SingleOrDefault(x => x.ID_vaksin == id);
            vaksin.status = 7;
            delVaksin.SaveChanges();
            delVaksin.Dispose();
            return true;
